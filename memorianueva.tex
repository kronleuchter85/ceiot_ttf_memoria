...
En el presente trabajo se documenta la implementación de una solución de IoT (Internet de las Cosas) para un caso de uso hipotético de robot de exploración ambiental, en el que, debido a la criticidad de los datos, sea necesario garantizar la inmutabilidad y transparencia de su almacenamiento.
