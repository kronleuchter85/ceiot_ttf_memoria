...
El presente trabajo describe la implementación de un proyecto personal en el que se desarrolla una solución de IoT (Internet de las Cosas) para un caso de uso de robot de exploración ambiental en el que, debido a la criticidad de los datos, sea necesario garantizar la inmutabilidad y transparencia de su almacenamiento.
