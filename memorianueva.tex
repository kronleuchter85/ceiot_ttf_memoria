...
Para su implementación se utilizaron conceptos y herramientas tales como el desarrollo de sistemas embebidos en ESP32 \citep{ESP32} y FreeRTOS \citep{FreeRTOS} usando ESP-IDF \citep{ESPIDF_home}, mensajeria MQTT \citep{mqtt_spec}, almacenamiento y procesamiento \textit{BigData}, la implementación de soluciones \textit{cloud}, entre otros.
