...
\begin{titlepage}
    ...
    \begin{flushright}
        ...
        \vspace*{4.5cm} % Ajustar según la posición vertical deseada
        ...
        Ciudad de Buenos Aires, abril de 2025} % Ejemplo: Ciudad de Córdoba, junio de 2025
    \end{flushright}
\end{titlepage}
